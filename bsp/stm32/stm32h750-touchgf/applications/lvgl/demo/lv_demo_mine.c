...
void lv_demo_mine(void)
{
    ...
    lv_obj_align(btn1, LV_ALIGN_RIGHT_MID, 0, -50);
    ...
    lv_obj_align(btn2, LV_ALIGN_RIGHT_MID, 0, -25);
    ...
    lv_obj_align(btn4, LV_ALIGN_RIGHT_MID, 0, 25);
    ...
    lv_obj_align(btn5, LV_ALIGN_RIGHT_MID, 0, 50);
